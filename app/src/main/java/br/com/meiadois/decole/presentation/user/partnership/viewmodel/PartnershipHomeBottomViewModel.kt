...
class PartnershipHomeBottomViewModel(
    ...
    fun getPartnerships(){
        ...
        partnershipLiveData.value = listOf(
            CompanyResponse(1, "Company 1", "00.00-00", "https://facebookbrand.com/wp-content/uploads/2019/04/f_logo_RGB-Hex-Blue_512.png?w=512&h=512","000.000.00-00", 1, SegmentResponse("Segmento 1")),
            CompanyResponse(2, "Company 2", "00.00-00", "https://seeklogo.com/images/R/Roche-logo-A80FCF9553-seeklogo.com.png","000.000.00-00", 2, SegmentResponse("Segmento 2")),
            CompanyResponse(3, "Company 3", "00.00-00", "https://loucoporandroid.com/wp-content/uploads/2015/09/uber.png","000.000.00-00", 3, SegmentResponse("Segmento 3"))
        )
    }
